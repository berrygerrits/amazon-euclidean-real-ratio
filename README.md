...
Explore [`notebooks/compute_ratio.ipynb`](notebooks/compute_ratio.ipynb) and observe the mean Golden Ratio ≈ 1.61. Coincidentally, the more well-known [Golden Ratio](https://en.wikipedia.org/wiki/Golden_ratio), $\phi = \frac{1+\sqrt{5}}{2} \approx 1.61$.
